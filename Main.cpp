// Your name
// Your partner's name (if none, delete this line)
 ...
 */
const std::string kYourName = "Chase";

/* Change these constants to contain the paths out of your mazes. */
const std::string kPathOutOfNormalMaze = "WWSWSEWNEESSWWEENNSES";
const std::string kPathOutOfTwistyMaze = "SWENSWSEWNWWSWW";
